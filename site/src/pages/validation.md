...
OAuthLint's whole value rests on a low false-positive rate. A security linter that cries wolf gets turned off. This page records how the full rule pack (270+ rules across eleven languages: JavaScript, TypeScript, Python, Go, C#, and more, plus mobile auth for Swift/iOS and Android) behaves when it is run against real, widely-used code.
