...
pack covers **138 rules across five languages: JavaScript/TypeScript, Python, Go,
Rust, and Java**, including dataflow (taint) rules for open-redirect and SSRF, and
