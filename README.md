...
84 Semgrep rules (JS/TS · Python · Go · Java · Rust) · CLI + GitHub Action + VS Code extension · free & MIT licensed
...
84 rules across OAuth 2.0, OIDC, JWT, cookies, CORS and session hygiene (42 JavaScript/TypeScript + 12 Python + 12 Go + 12 Java + 6 Rust) — each mapped to CWE & OWASP, each with a documentation page.
...
|---------|--------------|
| [`rules/`](rules) | 84 Semgrep rules (JS/TS · Python · Go · Java · Rust), schema-validated, with vulnerable + safe fixtures |
